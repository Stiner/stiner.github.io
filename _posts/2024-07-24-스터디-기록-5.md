...
컴파일러가 .cpp 파일 1개를 번역하면 결과물로 Object 파일 1개 생성. .cpp 1개는 컴파일러가 번역하는 제일 작은 단위이며 이를 번역단위라고 함.
...
컴파일러는 한번에 1개의 번역단위만 처리하기 때문에 외부 전역변수나 함수 처리시 있다고 가정하고 번역을 진행 함.

이렇게 나온 Object 파일들을 모아서 완성된 실행파일로 만드는 것은 Linker 의 몫.

![alt text](/assets/images/2024-07-24-스터디-기록-5/image0.png)
